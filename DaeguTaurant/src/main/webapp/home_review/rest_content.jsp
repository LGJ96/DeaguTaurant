                  ...
                  <div class="row">
                      ...
                      <div class="col-md-3">
                          <div class="reserve-seat-block">
                           ...
                           onclick="window.open('reviewWrite.html','','width=430,height=500,location=no,status=no,scrollbars=yes');">평점및리뷰등록</button>
                        ...
                        <td class="menu_td">
                          <ul class="Restaurant_MenuList">
                              <li class="Restaurant_MenuItem">
                                <span class="Restaurant_Menu">로스(등심)카츠</span>
                                  <span class="Restaurant_MenuPrice">13,000원</span>
                              </li>
                              <li class="Restaurant_MenuItem">
                                <span class="Restaurant_Menu">히레(안심)카츠</span>
                                  <span class="Restaurant_MenuPrice">14,000원</span>
                              </li>
                              <li class="Restaurant_MenuItem">
                                <span class="Restaurant_Menu">특로스(상등심)카츠</span>
                                  <span class="Restaurant_MenuPrice">16,000원</span>
                              </li>
                              <li class="Restaurant_MenuItem">
                                <span class="Restaurant_Menu">카츠산도</span>
                                  <span class="Restaurant_MenuPrice">14,000원</span>
                              </li>
                          </ul>
                        </td>
                            ...
                            <div class="card-body">
                              ...
                              <div class="customer-review_wrap">
                                  ...
                                  <div class="customer-content-wrap">
                                      <div class="customer-content">
                                          ...
                                          <div class="row">
                                            <div class="col-md-7 responsive-wrap">
                                             ...
                                             <script>ratings = {RatingScore_review1: 5} 
	                                          totalRating = 5;
                                      ...
                                      <div class="row">
                                      <div class="col-md-12 responsive-wrap">
                                      <p class="customer-text">여기 왕돈까스 너무 맛있고 푸짐합니다. 직원들도 친절하거 서비스가 좋아서 인기있는 최고의 돈까스 식당입니다. 
                                      </p>
                                      <p class="customer-text">오픈형 주방이라서 청결함을 유지하고 있고 조리과정을 볼 수 있어서 너무 좋습니다! 바삭한 일식 돈까스의 느낌이라서 너무 맛있는 맛집입니다.
                                      </p>
                                      <ul>
                              ...
                              <div class="customer-review_wrap">
                                  ...
                                  <div class="customer-content-wrap">
                                      <div class="customer-content">
                                          ...
                                          <div class="row">
                                            <div class="col-md-7 responsive-wrap">
                                             <div class='RatingStar_review2'>
                                            <div class='RatingScore_review2'>
                                              <div class='outer-star'><div class='inner-star'></div></div>
                                            </div>
                                          </div>
