              ...
              <span class="icon-menu"></span>
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                            <ul class="navbar-nav">
                                ...
                                <li><a href="../home_review/index.html" class="btn btn-outline-light top-btn"><span class="ti-plus"></span> admin</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
...
<!-- 글쓰기 버튼 생성 -->
	<div align="center">
	 ...
	 <a href="../servicecenter/servicecenter.html"><button class="btn btn-warning" > 취소</button></a>
