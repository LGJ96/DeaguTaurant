        ...
        <div class="col-sm-12" align="center">
              ...
              <div id= "title-header1" >
               ...
               <div class="col-md-11" style="text-align : right;">
 				<div class="container">
       				<button class="btn" onclick="location.href='../servicecenter/center-write.html';"  > 등록</button>
            </div>
            </div>
...
<div class="col-md-11" style="text-align : right;">
 ...
 <button class="btn btn-warning"  
  onclick="window.open('question-box.html','','width=430,height=500,location=no,status=no,scrollbars=yes');">1:1문의</button>
</div>
</div>
   <!--============================= FOOTER =============================-->
    <footer>
