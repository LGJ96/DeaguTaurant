...
import comm.service.CommContentService;
import comm.vo.CommVO;
import vo.ActionForward;

public class CommContentAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		CommContentService commContentService = new CommContentService();
		
		CommVO comArticle = commContentService.getArticle(com_number);
